...
const CreativeSkuPage: React.FC<PageProps> = (props) => {
  ...
  const labels = {
    en: {
      ...
      serviceName: 'CreativeSKU Creative Supply Service',
      visit: 'Visit Website',
    ...
    zh: {
      category: '产品更新',
      relatedService: '相关服务',
      serviceName: 'CreativeSKU 创意供给服务',
      visit: '访问官网',
  ...
  // Custom Sidebar Card for Related Service
  const sidebarExtra = (
...
export default CreativeSkuPage;
