...
const AiFullStackPage: React.FC<PageProps> = (props) => {
  ...
  const labels = {
    en: {
      ...
      serviceName: 'AI FullStack Enterprise Consulting',
      visit: 'Visit Website',
    ...
    zh: {
      category: '产品更新',
      relatedService: '相关服务',
      serviceName: 'AI FullStack 企业咨询服务',
      visit: '访问官网',
  ...
  const sidebarExtra = (
    <div className="bg-gray-50 rounded-[20px] p-6 border border-gray-100 mt-6 shadow-sm">
      ...
      <a 
        href="https://fullstack.tezign.com/"
        target="_blank"
